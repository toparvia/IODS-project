...
I also moved to the next set excercises DataCamp: Regression and model validation.
...
```
I found this code quite useful for getting an overview of the data. I have previously used a more simple plotting tools for initial analysis such as Pearson correlation or histograms separately, but I might use this one again since it provides insight with only one figure.
